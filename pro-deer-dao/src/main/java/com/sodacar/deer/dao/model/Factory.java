...
public class Factory {
    ...
    public Factory(String uuid, String number, String name, String code, Boolean enabled, DateTime createdAt, String createdByName, String createdByType, DateTime updatedAt, String updatedByName, String updatedByType) {
        this.uuid = uuid;
        this.number = number;
        this.name = name;
        this.code = code;
