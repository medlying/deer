...
public class VehicleAssignDealerLog {
    private String uuid;
    ...
    public VehicleAssignDealerLog(String uuid, String dealerName, Boolean status, DateTime createdAt, String createdByName, String createdByType) {
        this.uuid = uuid;
